      ...
      <div class="card">
        <form method="POST" action="{{ route('register') }}">
          <div class="card-content">
            ...
            <x-input name="firstname" type="text" icon="person" label="Prénom" required="true"></x-input>

            <x-input name="name" type="text" icon="person" label="Nom" required="true"></x-input>
            ...
            <div class="row col s12">
              <label>
                ...
                <span>J'accepte les termes et conditions de <a href="#" target="_blank">la politique de
