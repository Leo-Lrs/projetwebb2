          ...
          <![endif]-->
              <div class="mj-column-per-100 mj-outlook-group-fix"
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                  ...
                  <tr>
                    <td align="center"
                      style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-left:25px;word-break:break-word;">
                      <div
                        style="font-family:Helvetica;font-size:20px;line-height:20px;text-align:center;color:#9dc3c1;">
                        Bonjour {{ $user->firstname . ' ' . $user->name }}</div>
                    </td>
                  </tr>
                  <tr>
                    <td align="center"
                      ...
                      <div
                        style="font-family:Helvetica;font-size:20px;line-height:20px;text-align:center;color:#9dc3c1;">
                        Merci d'avoir effectué un achat sur notre boutique</div>
                    </td>
                  </tr>
                </table>
              </div>
      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="center"
                      ...
                      <div
                        style="font-family:Helvetica;font-size:18px;line-height:20px;text-align:center;color:#FFFFFF;">
                        Détails de la commande référence <strong>{{ $order->reference }}</strong></div>
                    </td>
                  </tr>
                  <tr>
          ...
          <tr>
            <td align="left"
              ...
              <div style="font-family:Helvetica;font-size:16px;line-height:20px;text-align:left;color:#FFFFFF;"><br />
                Date : {{ $order->created_at->format('d/m/Y') }}<br /><br /> Paiement : {{ $order->payment_text }}</div>
            </td>
          </tr>
      </table>
    </div>
      ...
      <![endif]-->
                ...
                <tr>
                  <td align="left"
                    ...
                    <div style="font-family:Helvetica;font-size:16px;line-height:20px;text-align:left;color:#FFFFFF;">
                      @if($order->payment === 'cheque') <p>Veuillez nous envoyer un chèque avec :</p>
                      <ul>
                        <li>montant du règlement : <strong>{{ number_format($order->totalOrder, 2, ',', ' ') }}
                            €</strong></li>
                      ...
                      <ul>
                        <li>montant du virement : <strong>{{ number_format($order->totalOrder, 2, ',', ' ') }}
                            €</strong></li>
  ...
  <!--[if mso | IE]>
      ...
      >
        <tr>
          <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
      <![endif]-->
  <div style="background:#1b1d1e;background-color:#1b1d1e;margin:0px auto;max-width:600px;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
      style="background:#1b1d1e;background-color:#1b1d1e;width:100%;">
      <tbody>
        <tr>
          ...
          <![endif]-->
            <div class="mj-column-per-100 mj-outlook-group-fix"
              ...
              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                ...
                <tr>
                  <td align="center"
                    style="font-size:0px;padding:10px 25px;padding-top:20px;padding-right:25px;padding-left:25px;word-break:break-word;">
                    <div style="font-family:Helvetica;font-size:18px;line-height:20px;text-align:center;color:#dddddd;">
                ...
                <tr>
                  <td align="justify"
                    style="font-size:0px;padding:10px 25px;padding-right:25px;padding-bottom:20px;padding-left:25px;word-break:break-word;">
                    <div
                      style="font-family:Helvetica;font-size:12px;line-height:20px;text-align:justify;color:#dddddd;">
                      {!! $page->text !!}</div>
                  </td>
                </tr>
              </table>
              ...
              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                ...
                <tr>
                  <td align="center"
                    ...
                    <div style="font-family:Helvetica;font-size:15px;line-height:20px;text-align:center;color:#555555;">
                      <a href="https://shopping.fgainza.fr" target="_blank">KoPaTiK</a></div>
                  </td>
                </tr>
              </table>
            </div>
