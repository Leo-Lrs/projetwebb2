...
<div class="container">
  <form id="form" action="{{ route('commandes.store') }}" method="POST">
    ...
    <ul class="collection with-header">
      ...
      <div id="wrapper">
        <li class="collection-item">
          ...
          <div class="row">
            <div class="col s12">
              <a href="{{route('adresses.index')}}" class="btn" style="width: 100%"><i
                  class="material-icons left">location_on</i>Gérer mes Adresses</a>
            </div>
          </div>
          <div class="row">
            <div class="col s12">
        ...
        <li class="collection-item">
          ...
          <p style="margin-left: 40px" class="hide">
            Envoyez un bon de commande avec la mention "Bon pour accord". Votre commande sera expédiée dès réception de
          ...
          <p style="margin-left: 40px" class="hide">
            Il vous faudra transférer le montant de la commande sur notre compte bancaire. Vous recevrez votre
            confirmation de commande comprenant nos coordonnées bancaires et le numéro de commande. Les biens seront mis
            de côté 30 jours pour vous et nous traiterons votre commande dès la réception du paiement.
          </p>
          @endif
          @if($shop->check)
          <p>
          ...
          <p style="margin-left: 40px" class="hide">
            Il vous faudra nous envoyer un chèque du montant de la commande. Vous recevrez votre confirmation de
            commande comprenant nos coordonnées bancaires et le numéro de commande. Les biens seront mis de côté 30
            jours pour vous et nous traiterons votre commande dès la réception du paiement.
          </p>
          @endif
        </li>
          ...
          <div class="row">
            <div class="col s12">
              <label>
                ...
                <span>J'ai lu <a href="#" target="_blank">les conditions générales de vente et les conditions
                    d'annulation</a> et j'y adhère sans réserve. </span>
              </label>
            </div>
          </div>
        </li>
    ...
    <div class="row">
      <div class="col s12">
        <button id="commande" type="submit" class="btn disabled" style="width: 100%">Commande avec obligation de
          paiement</button>
      </div>
    </div>
  </form>
