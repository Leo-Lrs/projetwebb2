    ...
    <li class="collection-item">
      ...
      <div id="payment-ok" class="center-align white-text red darken-4">
        <div class="card-content p-t-0-5 p-b-1">
          ...
          <p>Merci de recommencer le processus de commande si vous désirez toujours acheter les produits de votre
            panier.</p>
    ...
    <li class="collection-item">
      <div class="row">
        <div class="grid-example col s12 m6">
          <h5>Adresse de facturation @if($order->adresses->count() === 1)@endif</h5>
