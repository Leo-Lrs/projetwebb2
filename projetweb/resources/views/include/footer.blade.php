            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">25 rue de la poupée qui
                                    tousse, 31000 Toulouse, France</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">01 02 03 04
                                        05</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span
                                        class="text">contact@megagaming.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
