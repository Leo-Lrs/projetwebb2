...
<div class="container">
    ...
    <div class="modal-content p-b-0-5 center-align">
      ...
      <div class="modal-footer center-align">
        ...
        <a href="{{ route('panier.index') }}"
          class="btn waves-effect waves-light center-on-small-only pos-btn-100 p-small">
          Commander
        </a>
      </div>
    </div>
  ...
  <div class="row m-t-1-5">
    <div class="col s12 m6 center-align">
      <img style="max-height:600px;max-width:90%;width:auto;margin-top:auto;margin-bottom:auto;"
    ...
    <div class="col s12 m6">
      ...
      <form method="POST" action="{{ route('panier.store') }}">
        ...
        <div class="input-field m-y-2-5">
          ...
          <button class="btn waves-effect waves-light wshow align-btn nowrape m-btn-ajout" type="submit"
