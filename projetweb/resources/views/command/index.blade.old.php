    ...
    <ul class="collection with-header">
        ...
        <div class="row">
          <div class="col s12">
            @if($addresses->count() === 1)
              ...
              <span>Vous n'avez qu'une adresse enregistrée, si vous voulez une adresse différente pour la livraison <a href="{{ route('adresses.create') }}">vous pouvez en créer une autre</a>.</span>
            @else
                <label>
      ...
      <li class="collection-item">
        ...
        @if($shop->mandat)
          ...
          <p style="margin-left: 40px" class="hide">
            Envoyez un bon de commande avec la mention "Bon pour accord". Votre commande vous sera envoyé par mail réception de ce bon de commande. N'oubliez pas de préciser la référence de la commande dans votre bon.
          </p>
        @endif
        @if($shop->transfer)         
          <p>
