                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                  ...
                  <tr>
                    <td align="center"
                      ...
                      <div
                        style="font-family:Helvetica;font-size:20px;line-height:20px;text-align:center;color:#AABBAA;">
                        <strong>Paiement accepté</strong></div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left"
                      ...
                      <div style="font-family:Helvetica;font-size:18px;line-height:1;text-align:left;color:#FFFFFF;">
                        Paiement : {{ strtoupper($order->payment_text) }}</div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left"
                      ...
                      <div style="font-family:Helvetica;font-size:18px;line-height:1;text-align:left;color:#FFFFFF;">
                        Transaction ID : {{ $payment->payment_id }}</div>
                    </td>
                  </tr>
                </table>
              </div>
      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="center"
                      ...
                      <div
                        style="font-family:Helvetica;font-size:20px;line-height:20px;text-align:center;color:#AABBAA;">
                        <strong>Détails de la commande</strong></div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left"
