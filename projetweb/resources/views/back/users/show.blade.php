    ...
    <table class="table table-bordered table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><span class="badge badge-{{ config('colors.' . $order->state->color) }}">{{ $order->state->name }}</span>
          </td>
          <td style="text-align: center"><a href="{{ route('orders.show', $order->id) }}"
              class="btn btn-dark btn-sm">Voir</a></td>
        </tr>
        @endforeach
      </tbody>
    </table>
...
<div class="form-group row mb-0">
  <div class="col-md-12">
    <a class="btn btn-dark" href="{{ route('clients.index') }}" role="button"><i class="fas fa-arrow-left"></i> Retour à
