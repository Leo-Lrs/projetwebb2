      ...
      <div class="card">
        ...
        <form method="POST"
          ...
          <div class="card-body">
            ...
            <x-inputbs4 name="code" type="text" label="Code activation" :value="isset($product) ? $product->code : ''"
              required="true"></x-inputbs4>

            <x-inputbs4 name="quantity_alert" type="number" label="Quantité pour alerte stock"
              :value="isset($product) ? $product->quantity_alert : ''" required="true"></x-inputbs4>
            ...
            <div class="form-group">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="active" name="active" @if(old('active',
                  isset($product) ? $product->active : false)) checked @endif>
                <label class="custom-control-label" for="active">Produit actif</label>
              </div>
            </div>
            <div class="form-group row mb-0">
              <div class="col-md-12">
                <a class="btn btn-dark" href="{{ route('produits.index') }}" role="button"><i
